...
const TECH_STACK = ["React.js", "Next.js", "Node.js", "PostgreSQL", "GCP", "Microservices", "WebSockets"];
      ...
      <TileInner className="text-center">
        ...
        <BlurFade delay={0} inView>
          <div className="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full 
            ...
            <span className="text-xs text-[var(--body-muted)]">Open to opportunities</span>
          </div>
        </BlurFade>
        ...
        <BlurFade delay={0.3} inView>
          <p className="mx-auto mt-6 max-w-3xl t-lead text-[var(--body-muted)]">
            I build full-stack products and cloud infrastructure on GCP —
            from React frontends to production microservices and real-time systems.
          </p>
        </BlurFade>
        ...
        <BlurFade delay={0.4} inView>
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            ...
            <Button variant="secondaryPill" size="navPill" asChild>
              <a href="https://github.com/BhatAnkush" target="_blank" rel="noopener noreferrer">
                GitHub
              </a>
            </Button>
          </div>
